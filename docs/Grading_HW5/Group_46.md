Group: https://github.com/gargpriyam21/CSC510_G46_lua2py
...
|Docs: doco generated, format not ugly | 2 | Documentation present |
|Docs: what: point descriptions of each class/function (in isolation) | 2 | descriptions present |
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z| 2 | Instructions clear |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing| 3 | Good README.md |
...
|Test cases are routinely executed| 3 | Executed for each build |
...
|Short release cycles | 1 | only 1 release |
